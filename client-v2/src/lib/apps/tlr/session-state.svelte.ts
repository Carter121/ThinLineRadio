...
import type { AudioCoordinator } from './ui/AudioCoordinator.svelte.ts';
import { AlertFeedCardState } from './ui/dashboard/AlertFeedCardState.svelte.ts';
import { AudioPlayerState } from './ui/live-audio/AudioPlayerState.svelte.ts';

const PRIVATE_REFRESH_MS = 90_000;

/**
 * Shared TLR session lifecycle for the dashboard and PWA shells: auth state,
