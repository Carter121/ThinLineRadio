...
import {
	...
	type TlrSocketEvent
} from '$lib/apps/tlr/types.ts';
import { normalizeConfigSystems } from '$lib/apps/tlr/types.ts';
import { systemRef, talkgroupRef, TlrDirectory } from '$lib/apps/tlr/directory.ts';
