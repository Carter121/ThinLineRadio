<script lang="ts">
	...
	import type { Alert, TranscriptAnnotationUnit } from '$lib/apps/tlr/types.ts';
	import { formatRelativeTime, formatUnitName } from '$lib/apps/tlr/format.ts';
	import { fireStations, getIcon } from '$lib/apps/tlr/ui/map/stations.ts';
