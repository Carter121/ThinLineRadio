import { TlrApiError, type TlrClient } from '$lib/apps/tlr/tlr-client.ts';
...
import type { TlrConfig, Transcript, TlrSocketEvent } from '$lib/apps/tlr/types.ts';
import { TlrDirectory } from '$lib/apps/tlr/directory.ts';
