<script lang="ts">
	...
	import { useNumberFieldButton } from '$lib/components/ui/number-field/number-field.svelte.js';
	import type { NumberFieldButtonProps } from '$lib/components/ui/number-field/types.js';
