<script lang="ts">
	...
	import { useNumberFieldInput } from '$lib/components/ui/number-field/number-field.svelte.js';
	import type { NumberFieldInputProps } from '$lib/components/ui/number-field/types.js';
