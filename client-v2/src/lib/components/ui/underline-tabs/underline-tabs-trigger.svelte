<script lang="ts">
	...
	import { receive, send, useUnderlineTabsTrigger } from '$lib/components/ui/underline-tabs/underline-tabs.svelte.js';
...
<div class="relative h-full">
	<TabsPrimitive.Trigger
		...
		class={cn(
			...
			state.rootState.isHovered && state.rootState.hoveredTab === value && 'data-[state=inactive]:text-foreground!',
			className
		)}
		{...state.props}
		{...restProps}
